...
// ─── إضافة تلقائية للبيان فور إنشاء الشحنة (بغض النظر عن حالتها) ─────────────
// ⚠️ بالتصميم (تحديث 2026-08-29 بطلب صريح من مصطفى): الشحنة الجديدة بتتضاف
// فورًا لبيان العميل المفتوح — أو يتفتح لها بيان جديد لو مفيش بيان مفتوح أصلاً
// — من غير أي شرط على حالة الشحنة (status). قبل كده كانت الإضافة مربوطة بوصول
// الشحنة لحالة "قيد الشحن في المخزن" (warehouse_ready) أو أبعد، وكانت الشحنة
// تفضل "معلّقة" (من غير manifestId) قبل كده. النية اتغيّرت: أي شحنة جديدة —
// أيًا كانت حالتها وقت الإنشاء — تدخل البيان المفتوح فورًا.
//
