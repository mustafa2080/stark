    ...
    <div className="min-h-screen bg-[#050505] flex flex-col" dir="rtl">
      ...
      <main className="flex-1 flex flex-col items-center pt-24 sm:pt-28 pb-16 px-3 sm:px-4">
        ...
        {!loading && !error && shipments.length > 0 && (
          <ShipmentStatusHero
            status={shipments[0].status === "returned" && shipments[0].returnReceivedBy === "sender" ? "return_delivered" : shipments[0].status}
                          ...
                          <div className="rounded-2xl p-3"
                            ...
                            {shipment.courierPhone && (
                              <a
                                ...
                                className="mt-2.5 w-full flex items-center justify-center gap-1.5 px-2.5 py-2 rounded-xl text-xs font-bold transition-all hover:scale-[1.02] active:scale-95"
                                style={{
