...
<div class="page">
  ...
  <div class="details-row" style="grid-template-columns:1fr 1fr 1fr;margin-bottom:4px">
    ${(sh.canOpen !== null && sh.canOpen !== undefined) ? `<div class="detail-box" style="${(sh.canOpen === 0 || sh.canOpen === "0") ? "background:#fef2f2;border-color:#ef4444" : "background:#f0fdf4;border-color:#22c55e"}"><div class="d-label" style="${(sh.canOpen === 0 || sh.canOpen === "0") ? "color:#991b1b" : "color:#166534"}">حالة الشحنة (الفتح)</div><div class="d-value" style="${(sh.canOpen === 0 || sh.canOpen === "0") ? "color:#dc2626" : "color:#16a34a"}">${(sh.canOpen === 0 || sh.canOpen === "0") ? "غير مسموح بفتح الشحنة" : "مسموح بفتح الشحنة"}</div></div>` : `<div></div>`}
