  ...
  return (
    <>
      ...
      >
        ...
        <div
          dir="rtl"
          className="grid grid-cols-[28px_minmax(0,1fr)_74px_64px_56px] md:grid-cols-[28px_90px_minmax(0,0.65fr)_88px_84px_minmax(0,1.65fr)_84px_64px_92px_100px_90px] gap-0 items-start py-2.5 text-xs"
        >
          {/* تحديد */}
        ...
        <div className="space-y-3 mt-2">
          ...
          <div className="space-y-2">
            <div className="rounded-md bg-primary/10 border border-primary/30 overflow-hidden transition-all duration-300">
              ...
              >
                <p className="text-muted-foreground mb-0">صافي المستحق من المندوب</p>
                    ...
                    return (
                      <>
                        ...
                        <p className="text-[10px] text-muted-foreground mt-1">
                          إيرادات مستلمة ({formatCurrency(deliveredCODLocal)}) − تكلفة شحن ({formatCurrency(effectiveShipping)})
                        </p>
                      </>
                    );
                  })()}
    ...
    return (
      <>
        ...
        <AlertDialog open={confirmReceive} onOpenChange={setConfirmReceive}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>تأكيد الاستلام</AlertDialogTitle>
              <AlertDialogDescription>
                هل أنت متأكد من استلام طلبية <strong>{order.customerName}</strong> ({order.product}) من مندوب الشحن؟
                <br />سيتم إضافة البضاعة للمخزن.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        {showOrders && (
          <>
            {manifest.orders.length === 0 ? (
                ...
                <div dir="rtl" className="grid grid-cols-[28px_minmax(0,1fr)_74px_64px_56px] md:grid-cols-[28px_90px_minmax(0,0.65fr)_88px_84px_minmax(0,1.65fr)_84px_64px_92px_100px_90px] gap-0 border-b-2 border-border bg-muted/20 text-[10px] font-bold text-muted-foreground tracking-wide
