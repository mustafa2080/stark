...
const SECTION_GROUPS: Array<{
...
}> = [
  {
    ...
    permissions: [
      ...
      { key: "dashboard.delayed_shipments",     label: "الشحنات المتأخرة",                     desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.problem_shipments",     label: "الشحنات اللي فيها مشكلة",              desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.online_reps",           label: "المندوبين الموجودين حالياً",            desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.clients_followup",      label: "العملاء المحتاجين متابعة",              desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.live_map",              label: "الخريطة المباشرة",                     desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.performance_metrics",   label: "مؤشرات الأداء الخاصة بالشركة",          desc: "ظاهرة تلقائياً إلا لو اتشالت", sensitive: true },
      { key: "dashboard.revenue_summary",       label: "ملخص الإيرادات",                        desc: "ظاهرة تلقائياً إلا لو اتشالت", sensitive: true },
      { key: "dashboard.revenue_trend",         label: "اتجاه صافي الإيرادات",                  desc: "ظاهرة تلقائياً إلا لو اتشالت", sensitive: true },
      { key: "dashboard.ai_center",             label: "مركز الذكاء الاصطناعي",                 desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.top_clients",           label: "أفضل العملاء",                          desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.top_reps",              label: "أفضل المندوبين",                        desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.recent_events",         label: "أحدث التنبيهات",                        desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.recent_shipments",      label: "آخر الشحنات",                           desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.quick_actions",         label: "إجراءات سريعة",                         desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.reps_daily_table",      label: "جدول المندوبين اليومي",                  desc: "ظاهرة تلقائياً إلا لو اتشالت" },
      { key: "dashboard.executive_summary",     label: "شاشة المدير التنفيذي",                   desc: "ظاهرة تلقائياً إلا لو اتشالت", sensitive: true },
    ],
  },
  {
