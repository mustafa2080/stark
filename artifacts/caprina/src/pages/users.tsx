...
const PERM_TO_SECTION: Record<string, string> = {
  ...
  "dashboard.delayed_shipments":     "section_dashboard",
  "dashboard.problem_shipments":     "section_dashboard",
  "dashboard.online_reps":           "section_dashboard",
  "dashboard.clients_followup":      "section_dashboard",
  "dashboard.live_map":              "section_dashboard",
  "dashboard.performance_metrics":   "section_dashboard",
  "dashboard.revenue_summary":       "section_dashboard",
  "dashboard.revenue_trend":         "section_dashboard",
  "dashboard.ai_center":             "section_dashboard",
  "dashboard.top_clients":           "section_dashboard",
  "dashboard.top_reps":              "section_dashboard",
  "dashboard.recent_events":         "section_dashboard",
  "dashboard.recent_shipments":      "section_dashboard",
  "dashboard.quick_actions":         "section_dashboard",
  "dashboard.reps_daily_table":      "section_dashboard",
  "dashboard.executive_summary":     "section_dashboard",
  ...
  // حاويات صفحة المخزون
  "inventory_page.tab_shipments":        "section_inventory",
  "inventory_page.warehouse_ready_card": "section_inventory",
  "inventory_page.returned_card":        "section_inventory",
  "inventory_page.delayed_card":         "section_inventory",
  "inventory_page.sla_card":             "section_inventory",
  "inventory_page.proactive_alerts":     "section_inventory",
  "inventory_page.cash_reconciliation":  "section_inventory",
  "inventory_page.shipments_table":      "section_inventory",
  "inventory_page.summary_footer":       "section_inventory",
  "inventory_page.tab_insights":         "section_inventory",
  "inventory_page.net_collected":        "section_inventory",
  "inventory_page.cod_pending":          "section_inventory",
  "inventory_page.delivery_rate":        "section_inventory",
  "inventory_page.return_rate":          "section_inventory",
  "inventory_page.top_return_zones":     "section_inventory",
  "inventory_page.company_performance":  "section_inventory",
  "inventory_page.by_branch":            "section_inventory",
  "inventory_page.by_parcel_type":       "section_inventory",
  "inventory_page.status_distribution":  "section_inventory",
  "inventory_page.financial_summary":    "section_inventory",
  "inventory_page.tab_parcel_types":         "section_inventory",
  "inventory_page.parcel_types_count":       "section_inventory",
  "inventory_page.parcel_shipments_count":   "section_inventory",
  ...
  "shipments.invoices_btn":     "section_shipments",
  "shipments.tracking_btn":     "section_shipments",
  "shipments.analytics":        "section_shipments",
  "shipments.edit_status":      "section_shipments",
  "shipments.edit_data":        "section_shipments",
  ...
  "reps.analytics":               "section_reps",
  "reps.manifest_add_shipments":  "section_reps",
  "reps.manifest_close":          "section_reps",
  "reps.manifest_delete":         "section_reps",
  "reps.manifest_remove_order":   "section_reps",
  "reps.manifest_net_revenue":    "section_reps",
  "reps.card_total_revenue":      "section_reps",
  "reps.login_account":           "section_reps",
  // التحليلات
  ...
  // حاويات صفحة العملاء التجاريون
  "finance_clients.kpi_total_clients":     "section_finance",
  "finance_clients.kpi_monthly_collected": "section_finance",
  "finance_clients.kpi_total_outstanding": "section_finance",
  "finance_clients.kpi_total_shipments":   "section_finance",
  "finance_clients.top_clients":           "section_finance",
  "finance_clients.shipments_chart":       "section_finance",
  "finance_clients.sales_report_link":     "section_finance",
  "finance_clients.clients_table":         "section_finance",
  "finance_clients.add_client_btn":        "section_finance",
  ...
  "finance_hub.kpi_revenue":          "section_finance",
  "finance_hub.kpi_net_profit":       "section_finance",
  "finance_hub.kpi_expenses":         "section_finance",
  "finance_hub.monthly_chart":        "section_finance",
  "finance_hub.daily_cashflow":       "section_finance",
  "finance_hub.cash_map":             "section_finance",
  "finance_hub.pnl_statement":        "section_finance",
  "finance_hub.order_metrics":        "section_finance",
  "finance_hub.expense_pie":          "section_finance",
  "finance_hub.recent_transactions":  "section_finance",
  "finance_hub.break_even":           "section_finance",
  "finance_hub.mom_expense_report":   "section_finance",
  "finance_hub.shipping_dues":        "section_finance",
  "finance_hub.pending_purchases":    "section_finance",
  "finance_hub.quick_access":         "section_finance",
  // صفحة الخزنة
  "finance_cash.low_balance_alerts":    "section_finance",
  "finance_cash.smart_alerts":          "section_finance",
  "finance_cash.total_balance_banner":  "section_finance",
  "finance_cash.registers_grid":        "section_finance",
  "finance_cash.register_summary_stats":"section_finance",
  "finance_cash.cash_flow_chart":       "section_finance",
  "finance_cash.export_buttons":        "section_finance",
...
const SECTION_TO_PRIMARY_PERM: Record<string, string> = {
  ...
  "section_clients_business":    "finance.view",
...
const ALL_SECTIONS: Array<{ key: string; label: string; icon: string; color: string; bg: string }> = [
  { key: "section_dashboard",           label: "لوحة التحكم",          icon: "🏠", color: "text-emerald-400", bg: "bg-emerald-500/10 border-emerald-500/30" },
  { key: "section_clients_business",    label: "العملاء التجاريون",    icon: "🤝", color: "text-cyan-400",    bg: "bg-cyan-500/10 border-cyan-500/30" },
  { key: "section_shipments",           label: "الشحنات",              icon: "📦", color: "text-orange-400",  bg: "bg-orange-500/10 border-orange-500/30" },
  { key: "section_shipping_followup",   label: "متابعة الشحنات",       icon: "⏱️", color: "text-cyan-400",    bg: "bg-cyan-500/10 border-cyan-500/30" },
  { key: "section_reps",                label: "مناديب STARK",         icon: "🚚", color: "text-sky-400",     bg: "bg-sky-500/10 border-sky-500/30" },
  { key: "section_zones",               label: "المناطق",              icon: "🗺️", color: "text-cyan-400",    bg: "bg-cyan-500/10 border-cyan-500/30" },
  { key: "section_inventory",           label: "المخزون",              icon: "🏪", color: "text-violet-400",  bg: "bg-violet-500/10 border-violet-500/30" },
  ...
  { key: "section_product_performance", label: "أداء الشحنات",         icon: "📊", color: "text-pink-400",    bg: "bg-pink-500/10 border-pink-500/30" },
  ...
  { key: "section_sessions_report",     label: "تقارير الجلسات",       icon: "🕐", color: "text-slate-400",   bg: "bg-slate-500/10 border-slate-500/30" },
...
const SECTION_GROUPS: Array<{
...
}> = [
  {
    ...
    permissions: [
      ...
      { key: "dashboard.overview_kpis",         label: "نظرة عامة على الشحنات والإيرادات",     desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.cash_registers",        label: "إجمالي أرصدة الخزن",                  desc: "مخفية إلا لو اتفعّلت", sensitive: true },
      { key: "dashboard.status_distribution",   label: "توزيع الشحنات",                        desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.weekly_shipments",      label: "الشحنات الأسبوعية",                    desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.delayed_shipments",     label: "الشحنات المتأخرة",                     desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.problem_shipments",     label: "الشحنات اللي فيها مشكلة",              desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.online_reps",           label: "المندوبين الموجودين حالياً",            desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.clients_followup",      label: "العملاء المحتاجين متابعة",              desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.live_map",              label: "الخريطة المباشرة",                     desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.performance_metrics",   label: "مؤشرات الأداء الخاصة بالشركة",          desc: "مخفية إلا لو اتفعّلت", sensitive: true },
      { key: "dashboard.revenue_summary",       label: "ملخص الإيرادات",                        desc: "مخفية إلا لو اتفعّلت", sensitive: true },
      { key: "dashboard.revenue_trend",         label: "اتجاه صافي الإيرادات",                  desc: "مخفية إلا لو اتفعّلت", sensitive: true },
      { key: "dashboard.ai_center",             label: "مركز الذكاء الاصطناعي",                 desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.top_clients",           label: "أفضل العملاء",                          desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.top_reps",              label: "أفضل المندوبين",                        desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.recent_events",         label: "أحدث التنبيهات",                        desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.recent_shipments",      label: "آخر الشحنات",                           desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.quick_actions",         label: "إجراءات سريعة",                         desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.reps_daily_table",      label: "جدول المندوبين اليومي",                  desc: "مخفية إلا لو اتفعّلت" },
      { key: "dashboard.executive_summary",     label: "شاشة المدير التنفيذي",                   desc: "مخفية إلا لو اتفعّلت", sensitive: true },
    ],
  },
  {
    ...
    permissions: [
      ...
      // ── حاويات صفحة المخزون: تاب "شحنات المخزن" ─────────────────
      { key: "inventory_page.tab_shipments",        label: "تاب: شحنات المخزن",           desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.warehouse_ready_card", label: "كارت: قيد الشحن في المخزن",    desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.returned_card",        label: "كارت: مرتجع",                 desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.delayed_card",         label: "كارت: مؤجل",                  desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.sla_card",             label: "كارت: تجاوزت الوقت الطبيعي",   desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.proactive_alerts",     label: "لوحة التنبيهات الاستباقية",    desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.cash_reconciliation",  label: "مطابقة الكاش مع شركات الشحن",  desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.shipments_table",      label: "جدول الشحنات الرئيسي",         desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.summary_footer",       label: "ملخص أسفل الجدول",             desc: "ظاهر تلقائياً إلا لو اتشال" },
      // ── تاب "تحليلات" ───────────────────────────────────────────
      { key: "inventory_page.tab_insights",         label: "تاب: تحليلات",                desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.net_collected",        label: "كارت: صافي المحصّل",           desc: "ظاهر تلقائياً إلا لو اتشال", sensitive: true },
      { key: "inventory_page.cod_pending",          label: "كارت: COD المعلق في الطريق",   desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.delivery_rate",        label: "كارت: معدل التسليم",           desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.return_rate",          label: "كارت: معدل الإرجاع",           desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.top_return_zones",     label: "أكثر مناطق الإرجاع",           desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.company_performance",  label: "أداء شركات الشحن",             desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.by_branch",            label: "الشحنات حسب الفرع",            desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.by_parcel_type",       label: "الشحنات حسب نوع الطرد",        desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.status_distribution",  label: "توزيع حالات الشحنات",          desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.financial_summary",    label: "الملخص المالي للشحنات",        desc: "ظاهر تلقائياً إلا لو اتشال", sensitive: true },
      // ── تاب "أنواع الشحنات وأسعارها" ────────────────────────────
      { key: "inventory_page.tab_parcel_types",       label: "تاب: أنواع الشحنات وأسعارها", desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.parcel_types_count",     label: "كارت: إجمالي الأنواع",        desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.parcel_shipments_count", label: "كارت: الشحنات (كل الحالات)",  desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.parcel_total_revenue",   label: "كارت: إجمالي الإيرادات",      desc: "ظاهر تلقائياً إلا لو اتشال", sensitive: true },
      { key: "inventory_page.parcel_price_range",     label: "كارت: نطاق الأسعار",          desc: "ظاهر تلقائياً إلا لو اتشال" },
      { key: "inventory_page.parcel_types_table",     label: "جدول أنواع الطرود",           desc: "ظاهر تلقائياً إلا لو اتشال" },
    ],
  },
  {
    ...
    permissions: [
      ...
      { key: "shipments.delete",         label: "حذف الشحنة",                desc: "حذف الشحنة بشكل نهائي" },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "reps.create",                label: "إضافة مندوب",                    desc: "إضافة مندوب شحن جديد" },
      { key: "reps.analytics",             label: "التحليل الذكي للمناديب",         desc: "الوصول لتحليل مناديب الشحن الذكي" },
      { key: "reps.manifest_add_shipments", label: "إضافة شحنات لبيان المندوب",     desc: "إضافة شحنات لبيان الشحن الخاص بالمندوب" },
      { key: "reps.manifest_close",        label: "تقفيل بيان الشحن",               desc: "إغلاق/تقفيل بيان الشحن الخاص بالمندوب" },
      { key: "reps.manifest_delete",       label: "حذف بيان الشحن بالكامل",         desc: "حذف بيان الشحن كاملاً — منفصلة عن إلغاء أوردر واحد" },
      { key: "reps.manifest_remove_order", label: "إلغاء أوردر من بيان الشحن",      desc: "استبعاد شحنة واحدة من البيان دون حذف البيان نفسه" },
  ...
  {
    id: "finance_clients_page", label: "العملاء التجاريون (حاويات)", color: "text-rose-400", bgColor: "bg-rose-500/10 border-rose-500/30",
    icon: <Wallet className="w-4 h-4" />,
    permissions: [
      { key: "finance_clients.kpi_total_clients",     label: "كارت: إجمالي العملاء",       desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_clients.kpi_monthly_collected", label: "كارت: المحصّل هذا الشهر",    desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_clients.kpi_total_outstanding", label: "كارت: المستحق الإجمالي",     desc: "إخفاء إذا لم يُمنح", sensitive: true },
      ...
      { key: "finance_clients.sales_report_link",     label: "كارت: تقرير المبيعات",       desc: "إخفاء إذا لم يُمنح", sensitive: true },
  ...
  {
    id: "finance_hub_page", label: "لوحة الماليات الرئيسية (حاويات)", color: "text-rose-400", bgColor: "bg-rose-500/10 border-rose-500/30",
    icon: <Wallet className="w-4 h-4" />,
    permissions: [
      { key: "finance_hub.smart_alerts",        label: "شريط التنبيهات الذكية",          desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.kpi_cash",            label: "كارت: إجمالي الكاش",             desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.kpi_revenue",         label: "كارت: الإيراد",                  desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_hub.kpi_net_profit",      label: "كارت: صافي الربح",               desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_hub.kpi_expenses",        label: "كارت: المصروفات",                desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_hub.monthly_chart",       label: "رسم المبيعات والأرباح (6 شهور)",  desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_hub.daily_cashflow",      label: "كارت: التدفق النقدي اليومي",     desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.cash_map",            label: "كارت: الخزنة وتدفق الأموال",     desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.pnl_statement",       label: "كارت: قائمة الأرباح والخسائر",   desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_hub.order_metrics",       label: "كارت: مؤشرات الطلبات",           desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.expense_pie",         label: "كارت: توزيع المصروفات",          desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.recent_transactions", label: "كارت: آخر الحركات النقدية",      desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.break_even",          label: "كارت: نقطة التعادل",             desc: "إخفاء إذا لم يُمنح", sensitive: true },
      { key: "finance_hub.mom_expense_report",  label: "كارت: مقارنة المصروفات شهريًا",  desc: "إخفاء إذا لم يُمنح" },
      { key: "finance_hub.shipping_dues",       label: "كارت: مستحقات الشحن",            desc: "إخفاء إذا لم يُمنح" },
  ...
  {
    id: "finance_cash_page", label: "صفحة الخزنة", color: "text-amber-400", bgColor: "bg-amber-500/10 border-amber-500/30",
    icon: <Wallet className="w-4 h-4" />,
    permissions: [
