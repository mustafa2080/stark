...
const ALL_NAV = [
  ...
  { href: "/shipments-intelligence", label: "تحليل الشحنات الذكي", icon: Brain,                    permission: "analytics.smart",         section: "section_shipments_analytics", iconColor: "text-violet-400",    group: "orders"       },
  ...
  { href: "/representatives-intelligence", label: "التحليل الذكي لمناديب الشحن", icon: Brain,      permission: "shipping.view",           section: "section_shipping",           iconColor: "text-violet-400",     group: "shipping"     },
