...
const ALL_NAV = [
  ...
  { href: "/zones-intelligence", label: "تحليل المناطق الذكي", icon: Brain,          permission: "section_dashboard",       section: "section_dashboard",          iconColor: "text-violet-400",     group: "zones"        },
