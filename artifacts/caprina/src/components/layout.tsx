...
const ALL_NAV = [
  ...
  { href: "/live-map",          label: "الخريطة المباشرة",   icon: Navigation,      exact: true, permission: "section_dashboard",       section: "section_dashboard",          iconColor: "text-emerald-400",    group: "dashboard"    },
  { href: "/financial-dashboard", label: "لوحة الأرباح",     icon: Wallet,          exact: true, permission: "finance.view",            section: "section_dashboard",          iconColor: "text-yellow-400",     group: "dashboard"    },
