...
const ALL_NAV = [
  ...
  { href: "/finance/clients",   label: "العملاء التجاريون",   icon: UserCheck,                   permission: "finance.view",            section: "section_clients_business",   iconColor: "text-cyan-400",       group: "clients_business" },
  { href: "/finance/client-account-sheet", label: "حسابات العملاء", icon: UserCheck,               permission: "finance.view",            section: "section_clients_business",   iconColor: "text-cyan-400",       group: "clients_business" },
  { href: "/finance/pickup-requests", label: "طلبات الالتقاط",  icon: Truck,                       permission: "finance.view",            section: "section_clients_business",   iconColor: "text-cyan-400",       group: "clients_business" },
  { href: "/client-intelligence", label: "التحليل الذكي للعملاء", icon: Brain,                     permission: "section_clients_business", section: "section_clients_business",  iconColor: "text-violet-400",     group: "clients_business" },
  { href: "/shipments-list",    label: "الشحنات",             icon: Package,                     permission: "shipments.view",          section: "section_shipments",          iconColor: "text-orange-400",     group: "orders"       },
  { href: "/shipments/new",     label: "شحنة جديدة",            icon: Plus,                        permission: "shipments.create",        section: "section_shipments",          iconColor: "text-emerald-400",    group: "orders"       },
  { href: "/invoices",          label: "فواتير الشحن",             icon: FileText,                    permission: "shipments.invoices_btn",  section: "section_shipments",           iconColor: "text-yellow-400",     group: "orders"       },
  { href: "/shipping-followup", label: "متابعة الشحنات",        icon: Clock,                       permission: "shipments.tracking_btn",  section: "section_shipping_followup",  iconColor: "text-cyan-400",       group: "orders"       },
  { href: "/shipments-intelligence", label: "تحليل الشحنات الذكي", icon: Brain,                    permission: "shipments.analytics",     section: "section_shipments",           iconColor: "text-violet-400",    group: "orders"       },
  { href: "/shipping",          label: "مناديب STARK",         icon: Truck,                       permission: "reps.view",               section: "section_reps",               iconColor: "text-sky-400",        group: "shipping"     },
  { href: "/representatives-intelligence", label: "التحليل الذكي لمناديب الشحن", icon: Brain,      permission: "reps.analytics",          section: "section_reps",               iconColor: "text-violet-400",     group: "shipping"     },
  ...
  { href: "/shipments",         label: "المناطق",             icon: MapPin,          exact: true, permission: "zones.view",               section: "section_zones",               iconColor: "text-cyan-400",       group: "zones"        },
  { href: "/zones-intelligence", label: "تحليل المناطق الذكي", icon: Brain,          permission: "zones.view",               section: "section_zones",               iconColor: "text-violet-400",     group: "zones"        },
  ...
  // مخفي مؤقتًا (غير مستغل) — لسه موجود بالكود لإعادة الاستخدام مستقبلاً
...
const FINANCE_NAV = [
  ...
  { href: "/finance/trip-settlement",   label: "تسوية الرحلات والتحصيل", icon: Truck,   iconColor: "text-orange-400"   },
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        >
          <div className="w-full max-w-screen-2xl mx-auto p-3 sm:p-4 md:p-5 xl:p-6 2xl:p-8 min-w-0 overflow-x-hidden pb-[calc(7rem+env(safe-area-inset-bottom))] md:pb-8">
            {children}
          </div>
        </div>
        ...
        {/* ▼▼▼ الكود القديم أدناه بقى غير مستخدم — تم استبداله بالمكون أعلاه؛ سيُحذف نهائياً بعد التأكد ▼▼▼ */}
        {false && (() => {
          if (user?.role === "custom") {
