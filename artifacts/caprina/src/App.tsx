...
const ClientIntelligencePage = lazy(() => import("@/pages/client-intelligence"));
...
const FinanceTripSettlement = lazy(() => import("@/pages/finance-trip-settlement"));
...
const ClientAccountDashboardPage  = lazy(() => import("@/pages/client-account-dashboard"));
const FinancePickupRequestsPage   = lazy(() => import("@/pages/finance-pickup-requests"));
...
const ClientManifestsPage   = lazy(() => import("@/pages/client-manifests"));
    ...
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        <Switch>
          ...
          <Route path="/client-manifests/:id"     component={ClientManifestViewPage} />
          ...
          <Route path="/finance/client-account-sheet" component={() => <ProtectedRoute permission="finance.view" component={ClientAccountSheetPage} />} />
          <Route path="/finance/pickup-requests"  component={() => <ProtectedRoute permission="finance.view" component={FinancePickupRequestsPage} />} />
          <Route path="/finance/client-account-dashboard" component={() => <ProtectedRoute permission="finance.view" component={ClientAccountDashboardPage} />} />
          <Route path="/finance/client-account-sheet/detail/:phone" component={() => <ProtectedRoute permission="finance.view" component={ClientAccountDetailPage} />} />
          ...
          <Route path="/finance/client-account-sheet/manifest/:id" component={() => <ProtectedRoute permission="finance.view" component={ClientAccountManifestDetailPage} />} />

          <Route path="/finance/clients/:id"      component={() => <ProtectedRoute permission="finance.view" component={CommercialClientDetail} />} />
          <Route path="/finance/return-manifest/:id" component={() => <ProtectedRoute permission="finance.view" component={ClientReturnManifestDetail} />} />
          <Route path="/finance/sale-order-manifests/:id" component={() => <ProtectedRoute permission="finance.view" component={SaleOrderManifestDetailPage} />} />
          ...
          <Route path="/finance/trip-settlement" component={() => <ProtectedRoute permission="finance.trip_settlement" component={FinanceTripSettlement} />} />
          {/* Super Admin */}
